...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className={`bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 p-4 lg:p-6 transition-all duration-300 w-full ${isMobile ? 'pl-14' : ''}`}>
